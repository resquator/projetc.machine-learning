0,05042021105256,2,Decision Tree,"Pipeline(memory=None,
         steps=[('Scaler',
                ...
                ('TREE',
                 DecisionTreeClassifier(class_weight=None, criterion='gini',
                                        ...
                                        splitter='best'))],
         verbose=False)","{'TREE__criterion': ['gini', 'entropy'], 'TREE__max_depth': [None, 5, 10, 15, 20]}",0.9783236994219653,"[[236   2   0]
 [  3 215   8]
